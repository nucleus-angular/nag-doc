        ...
        while (args.length > 0) {
            ...
            switch (v) {
                ...
                case "--charset":
                    ...
                    Y.log('Setting default charset to ' + Y.charset, 'nag-doc', 'warn');
                    break;
                case "-c":
                case "--config":
                case "--configfile":
                ...
                case "--server":
                    ...
                    if (isNaN(p) || !p) {
                        ...
                        Y.log('Failed to extract port, setting to the default :3000', 'warn', 'nag-doc');
                    } else {
                        options.port = p;
                    }
                    break;
                ...
                case "--tab-to-space":
                    ...
                    break;
                case "--json-dir":
                    options.jsonDir = args.shift();
                    break;
                case "--web-dir":
                    options.webDir = args.shift();
                    break;
                default:
                    if (!options.paths) {
                        options.paths = [];
