...
YUI.add('help', function(Y) {
    ...
    */
    var help = [
        ...
        "",
        "Usage: nag-doc <options> <input path>",
        "",
        "Common Options:",
        "  -c, --config, --configfile <filename>  A JSON config file to provide configuration data.",
        "           You can also create a nag-doc.json file and place it",
        "           anywhere under your source tree and Nag Doc will find",
        "           it and use it.",
        ...
        "  -v, --version Show the current Nag Doc version",
        ...
        "  --server <port> Fire up the AngualrDoc server for faster API doc developement. Pass optional port to listen on. (default is 3000)",
